...
import ManageContacts from "./pages/ContactFinder/ManageContacts";
    ...
    const superAdminMenu = [
        {
            items: [
                ...
                { label: "Manage Contacts", icon: "custom-roles-icon", to: "/contact" },
                        ...
                        <div className="layout-main-container innr-Body">
                            <div className="layout-main">
                                ...
                                <Switch>
                                    ...
                                    <Route path="/contact" component={ManageContacts} />
                                    <Route path="/department" component={ManageDepartment} />
